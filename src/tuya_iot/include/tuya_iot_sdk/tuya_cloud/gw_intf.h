...
typedef struct {
	...
	//define by luowq
#ifdef DEF_USE_DUEROS_FILED
	CHAR_T dueros_uuid[DEUR_UUID_LEN +1];	//revice from cloud
	CHAR_T dueros_token[DUER_TOKEN_LEN + 1]; //revice from cloud
	CHAR_T dueros_bindToken[DUER_BIND_TOKEN_LEN + 1]; //revice from cloud
	UINT_T dueros_version;
#endif
}GW_ACTV_IF_S;
