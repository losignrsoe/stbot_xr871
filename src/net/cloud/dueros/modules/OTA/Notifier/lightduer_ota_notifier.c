...
static duer_package_info_ops_t *s_package_info_ops = NULL;
...
int duer_ota_register_package_info_ops(duer_package_info_ops_t *ops)
{
...
int duer_ota_notifier_state(duer_ota_updater_t *updater,  duer_ota_state state)
{
    int ret = DUER_OK;
    baidu_json *data_json = NULL;
...
int duer_ota_notifier_event(duer_ota_updater_t *updater, duer_ota_event event, double progress)
{
    int ret = DUER_OK;
    baidu_json *data_json = NULL;
