        ...
        duer_u32_t max_bitrate, duer_u32_t min_bitrate, duer_u32_t avg_bitrate)
{
    ...
    baidu_json_AddNumberToObject(message, "duration", duration);
    baidu_json_AddNumberToObject(message, "block_count", block_count);

    baidu_json_AddNumberToObject(code_bitrate, "max", max_bitrate);
    baidu_json_AddNumberToObject(code_bitrate, "min", min_bitrate);
    baidu_json_AddNumberToObject(code_bitrate, "avg", avg_bitrate);

    baidu_json_AddItemToObject(message, "codec_bitrate", code_bitrate);
...
duer_status_t duer_ds_log_audio_codec_version(const char *version)
{
    ...
    baidu_json_AddStringToObject(message, "codec_version", version);
        ...
        duer_u32_t sample_rate, duer_u32_t bits_per_sample, duer_u32_t channels)
{
    ...
    baidu_json_AddNumberToObject(message, "bitrate", bitrate);
    baidu_json_AddNumberToObject(message, "sample_rate", sample_rate);
    baidu_json_AddNumberToObject(message, "bits_per_sample", bits_per_sample);
    baidu_json_AddNumberToObject(message, "channels", channels);
...
duer_status_t duer_ds_log_audio_m4a_head_size(duer_u32_t size)
{
    ...
    baidu_json_AddNumberToObject(message, "head_size", size);
...
duer_status_t duer_ds_log_audio_content_type(const char *type)
{
    ...
    baidu_json_AddStringToObject(message, "content_type", type);
...
duer_status_t duer_ds_log_audio_download_delay()
{
    ...
    baidu_json_AddNumberToObject(message, "delay", delay);
...
duer_status_t duer_ds_log_audio_memory_overflow(const char *file, duer_u32_t line)
{
    ...
    baidu_json_AddStringToObject(message, "file", file);
...
duer_status_t duer_ds_log_audio_framework_error(int error_code)
{
    ...
    baidu_json_AddNumberToObject(message, "error_code", error_code);
