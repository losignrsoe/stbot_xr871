...
#else
__attribute__((weak)) void duer_dcs_alert_set_handler(const duer_dcs_alert_info_type *alert_info)
{
    static bool is_first_time = true;
...
__attribute__((weak)) duer_status_t duer_dcs_render_player_info_handler(baidu_json *payload)
{
	static bool is_first_time = true;

	DUER_DCS_HANDLER_UNREALIZE(is_first_time);
    DUER_LOGW("Please implement this interface to report get player info");
    return DUER_ERR_FAILED;
}

__attribute__((weak)) void duer_dcs_bluetooth_set_handler(bool is_switch, const char *target)
{
    static bool is_first_time = true;
...
__attribute__((weak)) void duer_dcs_bluetooth_connect_handler(bool is_connect, const char *target)
{
    static bool is_first_time = true;
