...
void duer_dcs_get_speaker_state(int *volume, bool *is_mute)
{
    ...
    *is_mute = false;
    ...
    do {
        ...
        *is_mute = (*env)->GetBooleanField(env, jstate, is_mute_id);
    } while (0);
...
void duer_dcs_mute_handler(bool is_mute)
{
    ...
    do {
        ...
        (*env)->CallIntMethod(env, s_speaker_control_listener, set_mute, is_mute);
    } while (0);
...
void duer_dcs_bluetooth_set_handler(bool is_switch, const char *target)
{
    ...
    do {
        ...
        (*env)->CallIntMethod(env, s_device_control_listener, set_bt, is_switch, jtarget);
    } while (0);
...
void duer_dcs_bluetooth_connect_handler(bool is_connect, const char *target)
{
    ...
    do {
        ...
        (*env)->CallIntMethod(env, s_device_control_listener, connect_bt, is_connect, jtarget);
    } while (0);
...
static void add_alert_array_to_list(JNIEnv *env, jobjectArray jalerts, baidu_json *alert_list)
{
    ...
    do {
        ...
        for (int i = 0; i < arraylength; ++i) {
            ...
            // get active field
            is_active = (*env)->GetBooleanField(env, jalert, active_id);
