...
static void lightduer_os_jni_initialize(JNIEnv *env, jclass clazz, jobject *jinfo)
{
    if (jinfo) {
        ...
        do {
            ...
            snprintf(g_system_static_info.os_version, OS_VERSION_LEN, "%s", str);
            ...
            jstr = (jstring)(*env)->GetObjectField(env, jinfo, id);
            str = (*env)->GetStringUTFChars(env, jstr, NULL);
            snprintf(g_system_static_info.sw_version, SW_VERSION_LEN, "%s", str);
            ...
            jstr = (jstring)(*env)->GetObjectField(env, jinfo, id);
            str = (*env)->GetStringUTFChars(env, jstr, NULL);
            snprintf(g_system_static_info.brand, BRAND_LEN, "%s", str);
            ...
            jstr = (jstring)(*env)->GetObjectField(env, jinfo, id);
            str = (*env)->GetStringUTFChars(env, jstr, NULL);
            snprintf(g_system_static_info.equipment_type, EQUIPMENT_TYPE_LEN, "%s", str);
            ...
            jstr = (jstring)(*env)->GetObjectField(env, jinfo, id);
            str = (*env)->GetStringUTFChars(env, jstr, NULL);
            snprintf(g_system_static_info.hardware_version, HARDWARE_VERSION_LEN, "%s", str);
